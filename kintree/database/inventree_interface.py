...
from ..search import search_api, automationdirect_api, digikey_api, mouser_api, element14_api, lcsc_api, jameco_api, tme_api, hestore_api
...
def translate_supplier_to_form(supplier: str, part_info: dict) -> dict:
    ...
    def get_value_from_user_key(user_key: str, default_key: str, default_value=None) -> str:
        ...
        if supplier == 'Digi-Key':
            ...
            user_search_key = settings.CONFIG_HESTORE.get(user_key, None)
    ...
    if supplier == 'Digi-Key':
        ...
        default_search_keys = hestore_api.get_default_search_keys()
    elif supplier == 'AutomationDirect':
...
def supplier_search(supplier: str, part_number: str, test_mode=False) -> dict:
    ...
    if part_cache:
        ...
        if supplier == 'Digi-Key':
            ...
            part_info = hestore_api.fetch_part_info(part_number)
        elif supplier == 'AutomationDirect':
